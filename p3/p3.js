...
function Score()
{
    ...
    text(ScoreP1,width/2-50,height/16);
    fill(255);
    text("|",width/2,height/16);
    fill("#0000ff");
    text(ScoreP2,width/2+40,height/16);
    fill("#ff0000")
    text(MW1,width/2-50,height/10);
    fill(255);
    text("|",width/2,height/10);
    fill("#0000ff");
    text(MW2,width/2+40,height/10);
    ...
    if( ScoreP2 >=STW)
    {
        ...
        fill("#0000ff");
       background(0); 
       text("BLÅ VINDER",width/2,width/2);
       if(keyIsDown(82))
       {    
           ScoreP1 = 0;
           ScoreP2 = 0;
    ...
    if(ScoreP1 >= STW )
    {
        ...
        fill("#ff0000");
       background(0); 
       text("RØD VINDER",width/2,width/2);
       if(keyIsDown(82))
       {    
           ScoreP1 = 0;
           ScoreP2 = 0;
